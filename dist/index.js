...
(function (module, exports) {
  ...
  function stringifiable(obj) {
    ...
    return _typeof(obj) === "object" && !("toString" in obj)
  ...
  var isProduction =
    (typeof process === "undefined" ? "undefined" : _typeof(process)) ===
      "object" && process.env.NODE_ENV === "production";
  ...
  exports["default"]["default"] = module.exports = assign(
    exports["default"],
    exports
  ); // invariants
...
function center(nodes, width, height) {
  var corners = calcCorners(
    __spreadArray(
      __spreadArray([], nodes, true),
...
function calcIntersectedConnections(internalNodes, internalConnections, rect) {
  ...
  for (
    var _i = 0, internalConnections_1 = internalConnections;
    _i < internalConnections_1.length;
    _i++
  ) {
...
function calcIntersectedNodes(internalNodes, edge) {
  ...
  internalNodes.forEach(function (item) {
    if (
      locateAngle(item).some(function (point) {
...
function calcGuidelines(node, nodes) {
  ...
  for (var i = 0; i < points.length; i++) {
    ...
    for (
      var _i = 0,
        _a = nodes.filter(function (internalNode) {
...
var OperationNode = function OperationNode(_a) {
  ...
  var color = typeof data.bgColor !== "undefined" ? data.bgColor : "white";
...
function Connection(_a) {
  ...
  var getNodeConnectorOffset = useCallback(
    function (nodeId, connectorPosition) {
        ...
        children: [
          /*#__PURE__*/ jsx("path", {
            ...
            d: "M "
              .concat(source[0], " ")
              .concat(source[1], " L ")
              .concat(destination[0], " ")
              .concat(destination[1]),
          ...
          /*#__PURE__*/ jsx("path", {
            ...
            onDoubleClick: function onDoubleClick(event) {
              event.stopPropagation();
              _onDoubleClick === null || _onDoubleClick === void 0
                ? void 0
      ...
      return /*#__PURE__*/ jsxs(Fragment, {
        children: [
          ...
          /*#__PURE__*/ jsx("path", {
            ...
            fill: "none",
            d: "M "
              .concat(source.join(" "), " L ")
              .concat(destination.join(" ")),
          }),
        ],
      });
    }),
...
var Flowchart = /*#__PURE__*/ forwardRef(function (_a, ref) {
  ...
  var internalCenter = useCallback(
    function () {
      if (!svgRef.current) {
        return;
      }
  ...
  var handleSVGDoubleClick = useCallback(
    function (event) {
      return onDoubleClick === null || onDoubleClick === void 0
        ? void 0
        : onDoubleClick(event, zoom);
    },
    [onDoubleClick, zoom]
  );
  var handleSVGMouseDown = useCallback(
    function (event) {
  ...
  var move = useCallback(
    function (nodeIds, x, y) {
      var _a;
  ...
  var handleSVGMouseMove = useCallback(
    function (event) {
      var _a;
      ...
      if (selectingInfo) {
        ...
        setSelectedNodeIds(
          calcIntersectedNodes(nodes, edge).map(function (item) {
            return item.id;
          })
        );
        setSelectedConnIds(
          calcIntersectedConnections(nodes, connections, edge).map(function (
            item,
            index
          ) {
            return index;
  ...
  var remove = useCallback(
    function () {
      ...
      var list1 = selectedConnIds.map(function (currentConn) {
        return [
          connections.findIndex(function (interConn, index) {
      ...
      var list2 = selectedNodeIds
        ...
        .flat()
        .map(function (currentConn) {
          return [
            connections.findIndex(function (interConn) {
      ...
      var restConnections = update(connections, {
        $splice: __spreadArray(
          __spreadArray([], list1, true),
          list2,
          true
        ).sort(function (a, b) {
          return b[0] - a[0];
      ...
      var restNodes = update(nodes, {
        $splice: selectedNodeIds
          .map(function (currNode) {
            return [
              nodes.findIndex(function (interNode) {
  ...
  var handleSVGKeyDown = useCallback(
    function (event) {
  ...
  var handleSVGMouseUp = useCallback(
    function (event) {
      var _a, _b, _c, _d;
      ...
      if (connectingInfo) {
        ...
        if (
          connections.find(function (item) {
            return (
              item.source.id === connectingInfo.source.id &&
              item.source.position === connectingInfo.sourcePosition &&
              item.destination.id === node_1.id &&
              item.destination.position === position_1
            );
          })
        ) {
          return;
        ...
        onChange === null || onChange === void 0
          ...
          : onChange(
              nodes,
              __spreadArray(
                __spreadArray([], connections, true),
                [newConnection],
                false
              )
            );
  ...
  var guidelines = useMemo(
    function () {
      var guidelines = [];

      if (movingInfo) {
        var _loop_2 = function _loop_2(source) {
          guidelines.push.apply(
            guidelines,
            calcGuidelines(
  ...
  var selectionAreaCorners = useMemo(
    function () {
      return selectingInfo
        ? calcCorners([selectingInfo.start, selectingInfo.end])
        : undefined;
    },
    [selectingInfo]
  );
  var zoomStyle = useMemo(
    function () {
      return {
        zoom: zoom,
      };
            ...
            return /*#__PURE__*/ jsx(
              Node,
              {
                ...
                onDoubleClick: function onDoubleClick(event) {
                  ...
                  onNodeDoubleClick === null || onNodeDoubleClick === void 0
                    ? void 0
                ...
                onMouseDown: function onMouseDown(event) {
                  ...
                  if (event.ctrlKey || event.metaKey) {
                    ...
                    if (index === -1) {
                      setSelectedNodeIds(
                        __spreadArray(
                          __spreadArray([], selectedNodeIds, true),
                          [formattedNode.id],
                          false
                        )
                      );
                    ...
                    if (
                      !selectedNodeIds.some(function (id) {
  ...
  var connectionElements = useMemo(
    function () {
      return connections === null || connections === void 0
        ? void 0
        : connections.map(function (conn, index) {
            return /*#__PURE__*/ jsx(
              Connection,
              {
                ...
                onDoubleClick: function onDoubleClick() {
                  return onConnDoubleClick === null ||
                    onConnDoubleClick === void 0
                    ? void 0
                    : onConnDoubleClick(conn);
                },
                onMouseDown: function onMouseDown(event) {
                  if (event.ctrlKey || event.metaKey) {
  ...
  var handleToolbarMouseDown = useCallback(
    function (type, event) {
  ...
  var handleContainerMouseMove = useCallback(
    function (event) {
